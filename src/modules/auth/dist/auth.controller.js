...
var acessToken_guard_1 = require("src/guards/acessToken.guard");
...
var AuthController = /** @class */ (function () {
    ...
    __decorate([
        swagger_1.ApiOperation({ summary: 'Method: Signup' }),
    ...
    __decorate([
        swagger_1.ApiOperation({ summary: 'Method: signin' }),
        swagger_1.ApiOkResponse({
    ...
    __decorate([
        swagger_1.ApiOperation({ summary: 'Method: Checking user phone number' }),
        swagger_1.ApiOkResponse({
            description: 'When user will write a phone number this method will send sms to his phone to verify'
        }),
        swagger_1.ApiForbiddenResponse({ description: 'Number not found' }),
    ...
    __decorate([
        ...
        swagger_1.ApiForbiddenResponse({ description: 'Unauthorized Request' }),
        common_1.UseGuards(acessToken_guard_1.AccessTokenGuard),
        common_1.Get('logout'),
        __param(0, common_1.Req())
    ], AuthController.prototype, "logout");
    __decorate([
        common_1.UseGuards(refreshToken_guard_1.RefreshTokenGuard),
